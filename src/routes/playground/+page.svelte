...
<p class="mt-2 text-gray-600">
	Type a name below — the breadcrumb updates instantly via optimistic update.
</p>
...
<p class="mt-1 text-sm text-gray-500">
	On input, a <code class="rounded bg-gray-100 px-1 text-sm">command</code> writes to the server
	while
